...
export class DeviceService {
	...
	/**
	 * Get List of device details for building details
	 * @param buildingGuid
	 */
	getDeviceDetailsList(buildingGuid) {

		return this.httpClient.get<any>(this.apiServer.baseUrl + 'api/device/getbuildingdevicesdetails/' + buildingGuid).map(response => {
			return response;
		});
	}
