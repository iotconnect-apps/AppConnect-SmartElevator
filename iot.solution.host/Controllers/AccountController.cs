...
namespace host.iot.solution.Controllers
{
    ...
    public class AccountController : BaseController
    {
        ...
        public AccountController(IUserService userService, IAdminUserService adminUserService, ISubscriberService subscriberService)
        {
        ...
        public Entity.BaseResponse<Entity.LoginResponse> AdminLogin(Entity.LoginRequest request)
        {
            ...
            try
            {
                ...
                if (loginResult != null && loginResult.Success)
                {
                    ...
                    var firstNameValue = firstName.GetValue(loginResult.Data, null);
