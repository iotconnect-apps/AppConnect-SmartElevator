...
001	sgh-1 06-12-2019 [Nishit Khakhi]	Added Initial Version to Delete Elevator
*******************************************************************/
CREATE PROCEDURE [dbo].[Elevator_Delete]
...
BEGIN
	...
	BEGIN
        ...
        SELECT @Param = 
        (
            SELECT 'Elevator_Delete' AS '@procName'             
