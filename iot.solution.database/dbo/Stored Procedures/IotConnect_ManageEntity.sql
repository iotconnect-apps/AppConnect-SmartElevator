...
EXEC [dbo].[IotConnect_ManageEntity]
	  @companyGuid	= '22C58E4B-1E7B-4B1E-A7DC-3EBD497D00C4'
     ,@EntityXml	= @EntityXml
	 ,@action		= 'insert'
...
002 SSES-2	18-03-2020 [Nishit Khakhi]	Updated for parentEntityGuid
 *******************************************************************/            
	...
	FROM @EntityXml.nodes('/items/item') a(b)
		...
		BEGIN TRAN
			...
			BEGIN
				...
				INSERT INTO [dbo].[Entity] ([guid], [parentEntityGuid], [name], [address], [city], [stateGuid], [countryGuid], [companyGuid], [isDeleted],[createdDate],[createdBy])
