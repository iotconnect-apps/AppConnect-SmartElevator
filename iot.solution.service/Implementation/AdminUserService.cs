...
namespace iot.solution.service.Implementation
{
    public class AdminUserService : IAdminUserService
    {
        ...
        public Entity.AdminUserResponse Get(Guid id)
        {
            ...
            {
                _logger.ErrorLog(ex, $"AdminUserService.Get, Error: { ex.Message} ");
                return null;
            }
        }
        ...
        public Entity.ActionStatus Manage(Entity.AddAdminUserRequest request)
        {
            ...
            {
                _logger.ErrorLog(ex, "AdminUserManager.Manage " + ex);
                actionStatus.Success = false;
        ...
        public Entity.ActionStatus Delete(Guid id)
        {
            ...
            {
                _logger.ErrorLog(ex, "AdminUserManager.Delete " + ex);
                actionStatus.Success = false;
                actionStatus.Message = ex.Message;
            }
        ...
        public ActionStatus UpdateStatus(Guid id, bool status)
        {
            ...
            {
                _logger.ErrorLog(ex, "AdminUserManager.UpdateStatus " + ex);
                actionStatus.Success = false;
                actionStatus.Message = ex.Message;
            }
        ...
        public Entity.ActionStatus ChangePassword(ChangePasswordRequest request)
        {
            ...
            {
                _logger.ErrorLog(ex, "AdminUserService.ChangePassword " + ex);
            }
            return result;
        }
    }
