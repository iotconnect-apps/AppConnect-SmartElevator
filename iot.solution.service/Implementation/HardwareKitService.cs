...
namespace iot.solution.service.Implementation
{
    public class HardwareKitService : IHardwareKitService
    {
        ...
        public HardwareKitService(IHardwareKitRepository hardwareKitRepository, IKitTypeAttributeRepository kitTypeAttributeRepository,IKitDeviceRepository kitDeviceRepository, IKitTypeRepository kitTypeRepository, ILogger logManager)
        {
        ...
        public Entity.HardwareKitDTO Get(Guid id)
        {
            return _hardwareKitRepository.FindBy(r => r.Guid == id).Select(p => new Entity.HardwareKitDTO()
            {
                ...
                Note = p.Note,
                Tag = p.TagGuid.HasValue ? p.TagGuid.Value.ToString() :"",
                KitCode = p.KitCode,
                UniqueId = p.UniqueId
            }).FirstOrDefault();
        }
